...
var Index = (function(window, $) {
	...
	_loadXEditable = function() {
		...
		$('#mainTableList').find('td').each(function() {
			...
			$(this).find('a[data-type="text"]').editable({
				emptytext: '&nbsp;&nbsp;&nbsp;',
				onblur: 'submit'
			});
		});
	...
	_loadFooterScroll = function() {
		$(window).scroll(function() {
			var scrollTop = $(this).scrollTop();
			console.log($(this).height());
			if (scrollTop > lastScrollTop && !$('input[type="text"]').is(":focus")) {
				$("#footer").slideDown();
				setTimeout(function(){$("#footer").slideUp();}, 5000);
			}
			else {
				$("#footer").slideUp();
			}
